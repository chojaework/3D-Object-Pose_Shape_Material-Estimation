...
class ScannetTestTimeDataset(CategoryDataset):
    ...
    def __getitem__(self, idx):
        ...
        # tag: data output
        base = {"coord": rot_base_coords, "origin":rot_base_coords, "feat": base_feat, "T": base_trans, "idx":idx}
        pos = {"coord": rot_pos_coords, "origin":rot_pos_coords, "feat": pos_feat, "T": pos_trans, "idx":self.id2idx[self.BestMatches[idx]]}    
